...
description: "A game-built digital twin of nuclear glovebox operations - replacing passive instruction with interactive, performance-tracked simulation for high-consequence work."
date: "2024-01-15"
tags:
  [
    "simulation",
...
published: true
hero: "/work/glovebox-1.png"
client: "Founder-led research · Los Alamos National Laboratory × ASU School of Manufacturing Systems and Networks"
metrics:
...
This research, with the ASU School of Manufacturing Systems and Networks, set out to build a better answer.
...
<MediaFrame
  ytId="sg8b28HVCJ8"
  label="In-engine · main menu"
  note="YouTube · click to play"
  aspect="16/9"
/>
...
<MediaRow>
  <MediaFrame
    src="/work/glovebox-2.png"
    alt="In-engine view of the facility environment surrounding the glovebox cells"
    label="In-engine · facility environment"
    note="UE5 · real-time"
    aspect="16/9"
  />
  <MediaFrame
    src="/work/glovebox-3.png"
    alt="In-engine view of the glovebox cells where trainees execute task sequences"
    label="In-engine · glovebox cells"
    note="UE5 · real-time"
    aspect="16/9"
  />
</MediaRow>
...
<MediaFrame
  ytId="QKBvUV2Dk9g"
  label="In-engine · wrist-panel controls"
  note="YouTube · click to play"
  aspect="16/9"
/>
...
<MediaFrame
  ytId="paSCMZT6_d4"
  label="In-engine · access-key sequence"
  note="YouTube · click to play"
  aspect="16/9"
/>
...
This project is a direct proof of the ArkaForge thesis: game technology is the most underutilized tool in high-stakes workforce training. The same systems that power real-time 3D games - physics, interaction, event logic, rendering, UI - are exactly the systems needed to build training environments that actually work.
...
_This project was developed by ArkaForge founder Harish in his individual capacity as a researcher and developer, in collaboration with the ASU School of Manufacturing Systems and Networks. It represents the direct technical foundation for ArkaForge's simulation and digital twin capabilities._
