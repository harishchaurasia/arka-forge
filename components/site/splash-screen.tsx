  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="font-display text-2xl font-bold tracking-tight text-primary md:text-3xl lg:text-4xl">
            ArkaForge
          </span>
          <span className="whitespace-nowrap font-mono text-[10px] uppercase tracking-[0.15em] text-primary/60 md:text-xs md:tracking-[0.22em] lg:text-sm">
