...
export const metadata: Metadata = {
  title: {
    default: "ArkaForge - Simulation-Based Training & Digital Twins",
    template: "%s | ArkaForge",
  },
  description: "ArkaForge builds simulation-based training systems and digital twins using game technology - for organizations where the gap between training and reality carries real cost.",
