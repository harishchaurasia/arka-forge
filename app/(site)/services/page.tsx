...
const pillars = [
  ...
  {
    title: "Digital twins",
    body: "Immersive digital twins of real-world procedures, built in a game engine for high-stakes training — interactive environments, task-sequence logic, real-time error detection and readiness scoring. The depth behind a performance-tracked nuclear glovebox trainer.",
